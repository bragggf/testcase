...
public class CAppConsts
{
   ...
   final static public String ErrorFile = null;
   ...
   final static public String DefaultForecaster = "1"; //MCIR
   final static public int RunBothFC = 3; 
   final static public int RunFC1 = 1; 
   final static public int RunFC2 = 2; 
   ...
   final static public String StatusDone = "Done";
   ...
   final static public int MaxLenAgeNum = 3;
