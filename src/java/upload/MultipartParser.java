 ...
 * that your servlet is hanging trying to read the input stream from the POST,
...
public class MultipartParser
{
   ...
   */
   public Part readNextPart() throws IOException
   {
      ...
      else if (line.length() == 0) return null;
      ...
      Object[] enumer = headers.toArray();
      for (int idx = 0; idx < enumer.length; idx++)
      {
         String headerline = (String) enumer[idx];
      ...
      {
         // This is a file
         if (filename.equals("")) filename = null; // empty filename, probably an "empty" file param
   ...
   */
   private String[] extractDispositionInfo(String line) throws IOException
   {
      ...
      if (start == -1 || end == -1) throw new IOException("Content disposition corrupt: " + origline);
   ...
   */
   private String extractContentType(String line) throws IOException
   {
      ...
      if (line.startsWith("content-type"))
      {
         ...
         if (start == -1) throw new IOException("Content type corrupt: " + origline);
         contentType = line.substring(start + 1);
      }
      else if (line.length() != 0) throw new IOException("Malformed line after disposition: " + origline);
