...
<body onload='javascript:unlockPage();setAgeMode()'>
<div class='topband'>
  <div class='logodiv'>
...
<div class='leftband'>
  <div class='btnlist'>
    <A OnMouseDown='javascript:SwapBtn("Save","SaveDn")' 
               ...
               HREF='javascript:if (ValidateSaveCase()) {EnableAllElements("EditForm");DoSubmit("EditForm","Save")}'>
...
<div class='centerband'>
  <form name='EditForm' id='EditForm' action='<%=CAppConsts.JspLinkCentral%>' method=post>
  <div class='pickdiv'>
